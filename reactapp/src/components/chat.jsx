              ...
              <div className="hidden lg:col-span-2 lg:block">
                  <div className="w-full">
                      <div className="relative flex items-center p-3 border-b border-gray-300">
                          <img className="object-cover w-10 h-10 rounded-full"
                              src="https://cdn.pixabay.com/photo/2018/01/15/07/51/woman-3083383__340.jpg" alt="username" />
                          <span className="block ml-2 font-bold text-gray-600">Nefri Manalo</span>
                      ...
                      <div className="relative w-full p-6 overflow-y-auto h-[40rem]">
                          <ul className="space-y-2">
                              ...
                              <li className="flex justify-start">
                                  <div className="relative max-w-xl px-4 py-2 text-gray-700 rounded shadow">
                                      <span className="block">pinaikot nilaro paalis mahal mo ako
                                      </span>
                                  </div>
                              </li>
                          </ul>
                      ...
                      <div className="flex items-center justify-between w-full p-3 border-t border-gray-300">
                          <button className="bg-pink-200 hover:bg-pink-700 ms-2">
                              <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-5
text-gray-500" fill="none" viewBox="0 0 24 24"
                          ...
                          <button type="submit" className="bg-pink-200 hover:bg-pink-700 ms-2">
